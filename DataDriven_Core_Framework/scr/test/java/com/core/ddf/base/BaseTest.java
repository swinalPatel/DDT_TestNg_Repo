...
public class BaseTest {
	...
	public static ExtentReports rep = ExtentManager.getReport();     // initiating new object (rep) of ExtentReports class by given function (geInstance) of ExtentManager class
	...
	// store screenshots in jpeg file
		public  void takeScreenShot() throws IOException {
			...
			test.log(Status.INFO, "screenshot--->" + test.addScreenCaptureFromPath(System.getProperty("user.dir") + "\\screenshots\\" + filename()+".jpeg"));
			}
